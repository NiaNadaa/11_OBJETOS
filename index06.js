...
let nombre = window.prompt("Escribe el nombre y apellido de la persona que quieres encontrar");
nombre=nombre.split(" ");
console.log(nombre);
nombre=nombre.join("");
console.log(nombre);

console.log(personas[nombre].name);

if(personas[nombre].name){
    console.log("true")
    document.getElementById("main").innerHTML=`
    <img src=${personas[nombre].picture}/>
    <h1>${personas[nombre].name}</h1>
    <p>Age: ${personas[nombre].age}</p>
    <p>Email: ${personas[nombre].email}</p>
    <p>Address: ${personas[nombre].address}</p>`
    document.getElementById("main").style.backgroundColor=`${personas[nombre].eyeColor}`
};
