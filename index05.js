...
let date = window.prompt("Introduce el año de tu nacimiento").substring(3);
...
let sexo = window.prompt("Quieres el nombre masculino o femenino?");

console.log(date); //9
console.log(nombre); //c
console.log(apellido); //r
