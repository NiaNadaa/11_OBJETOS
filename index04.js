...
let res = window.prompt("Introduce un nombre");
randomObject.them.speed.past.program.grade.addition.whose.national.cannot.name=res;
console.log(randomObject.them.speed.past.program.grade.addition.whose.national.cannot);